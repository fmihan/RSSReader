...
class RealmITunesNamespace: Object {
    ...
    /// </itunes:category>
    public var iTunesCategories = List<RealmItunesCategory>()
    ...
    public var iTunesImage: RealmItunesImage? = RealmItunesImage()
...
extension RealmITunesNamespace {

    func assignValues(from rssItunes: ITunesNamespace?) {
        guard let rssItunes else { return }
        iTunesAuthor = rssItunes.iTunesAuthor
        iTunesBlock = rssItunes.iTunesBlock
        iTunesExplicit = rssItunes.iTunesExplicit
        isClosedCaptioned = rssItunes.isClosedCaptioned
        iTunesComplete = rssItunes.iTunesComplete
        iTunesNewFeedURL = rssItunes.iTunesNewFeedURL
        iTunesTitle = rssItunes.iTunesTitle
        iTunesSubtitle = rssItunes.iTunesSubtitle
        iTunesSummary = rssItunes.iTunesSummary
        iTunesKeywords = rssItunes.iTunesKeywords
        iTunesType = rssItunes.iTunesType
        iTunesEpisodeType = rssItunes.iTunesEpisodeType
        iTunesDuration = rssItunes.iTunesDuration
        iTunesSeason = rssItunes.iTunesSeason
        iTunesOrder = rssItunes.iTunesOrder
        iTunesEpisode = rssItunes.iTunesEpisode

        iTunesImage?.assignValues(from: rssItunes.iTunesImage)
        iTunesCategories.assignValues(from: rssItunes.iTunesCategories)
    }
